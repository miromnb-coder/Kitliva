...
const styles = StyleSheet.create({
  ...
  viewText: { color: colors.mutedStrong, fontSize: 12, fontWeight: "500", marginRight: 4 },
  content: { marginTop: 16, flexDirection: "row" },
  image: { width: 116, height: 86, borderRadius: 12, backgroundColor: colors.softGold },
  imagePlaceholder: { width: 116, height: 86, borderRadius: 12, alignItems: "center", justifyContent: "center", backgroundColor: colors.softGold },
  ...
  statusPill: { height: 24, alignSelf: "flex-start", flexDirection: "row", alignItems: "center", borderRadius: 12, backgroundColor: colors.softGold, paddingHorizontal: 10, marginTop: 8 },
  statusDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: colors.accent, marginRight: 6 },
  statusText: { color: colors.mutedStrong, fontSize: 11, fontWeight: "500", textTransform: "capitalize" },
