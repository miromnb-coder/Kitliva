...
const reasons = ["Profile concern", "Conversation concern", "No-show", "Outside app request", "Other"];
...
export default function MemberFeedbackScreen() {
  ...
  async function submit() {
    ...
    setSending(true);
    const result = await createReport({ reporterId: user.id, type: "user", reportedUserId: id, reason, details });
    setSending(false);
