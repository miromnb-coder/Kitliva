    ...
    <Screen noPadding>
      <ScrollView style={styles.screen} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.statusCard}>
          <View style={styles.statusIcon}><Ionicons name="eye-outline" size={19} color="#A77C3A" /></View>
...
const styles = StyleSheet.create({
  ...
  statusCard: { minHeight: 62, flexDirection: "row", alignItems: "center", borderRadius: 16, borderWidth: 1, borderColor: colors.border, backgroundColor: "#F7F2EB", padding: 13, marginTop: 20, marginBottom: 12 },
  ...
  photoPlaceholder: { width: 58, height: 58, alignItems: "center", justifyContent: "center", borderRadius: 13, backgroundColor: "#F7F2EB", marginRight: 13 },
  ...
  messageCard: { minHeight: 40, justifyContent: "center", borderRadius: 14, borderWidth: 1, borderColor: colors.border, backgroundColor: "#F7F2EB", paddingHorizontal: 12, marginBottom: 14 },
  messageText: { color: "#7B623C", fontSize: 12.5, fontWeight: "700" },
  saveButton: { height: 50, alignItems: "center", justifyContent: "center", borderRadius: 12, backgroundColor: "#171717", marginTop: 4, marginBottom: 16 },
